...
var oname;
var unreads = 0;
var fvals = {Hack:"cr","Gold":"g",Candy:"g",Defense2:"d",Pirate:"d",Fish:"w",Brawl:"xp",Factory:"ca"};
var cheats = {"Hack":[{
...
type:"button",name:"Crash host(candy)",action:function(a){setUserVal("g/t","t");a.innerText="Crashing";}
},{
type:"button",name:"Freeze Scoreboard",action:function(a){if(a.frozen!=undefined){a.frozen=!a.frozen;}else{a.frozen=true;}if(a.frozen){setUserVal("tat/t","t");}else{setUserVal("tat","t");}a.innerText=a.frozen?"Unfreeze Scoreboard":"Freeze Scoreboard";}
},{
type:"select",name:"Steal Candy From",computed:function(sel){if(Object.keys(gameobject.c).length===Array.from(sel.children).length){return false;}return Object.keys(gameobject.c);},action:function(d){setUserVal("tat",`${d}:${prompt("How much candy do you want to steal?")}`);}
},
{
type:"select",name:"Set Player's Candy",computed:function(sel){if(Object.keys(gameobject.c).length===Array.from(sel.children).length){return false;}return Object.keys(gameobject.c);},action:function(d){setUserVal("tat",`${d}:swap:${prompt("What do you want to set it to?")}`);}
},{
type:"input",name:"Set Candy",action:function(amt){setUserVal("g",amt);}
},{
type:"select",name:"Send Ad Text",computed:function(sel){if(Object.keys(gameobject.c).length===Array.from(sel.children).length){return false;}return Object.keys(gameobject.c);},action:function(d){var adtext = prompt("Enter the text you would like to send (this will override your blook):");if(adtext){if(adtext.includes(":")){alert("Ad text cannot include a colon!");return;}setUserVal("b","Dog:"+(new Array(500).fill(adtext).join(" ")));setUserVal("tat",`${d}:100`);}}
},{
type:"input",name:"Flood Alert Box",action:function(stext){setUserVal("tat",`${botinfo.name}:${Date.now()}${(new Array(1700).fill(stext+" ")).join("")}`);}
...
type:"button",name:"Crash host(toy)",action:function(a){setUserVal("t/t","t");a.innerText="Crashing";}
},{
type:"button",name:"Freeze Scoreboard",action:function(a){if(a.frozen!=undefined){a.frozen=!a.frozen;}else{a.frozen=true;}if(a.frozen){setUserVal("tat/t","t");}else{setUserVal("tat","t");}a.innerText=a.frozen?"Unfreeze Scoreboard":"Freeze Scoreboard";}
},{
type:"select",name:"Steal Toys From",computed:function(sel){if(Object.keys(gameobject.c).length===Array.from(sel.children).length){return false;}return Object.keys(gameobject.c);},action:function(d){setUserVal("tat",`${d}:${prompt("How many toys do you want to steal?")}`);}
},
{
type:"select",name:"Set Player's Toys",computed:function(sel){if(Object.keys(gameobject.c).length===Array.from(sel.children).length){return false;}return Object.keys(gameobject.c);},action:function(d){setUserVal("tat",`${d}:swap:${prompt("What do you want to set it to?")}`);}
},{
type:"input",name:"Set Toys",action:function(amt){setUserVal("t",amt);}
},{
type:"select",name:"Send Ad Text",computed:function(sel){if(Object.keys(gameobject.c).length===Array.from(sel.children).length){return false;}return Object.keys(gameobject.c);},action:function(d){var adtext = prompt("Enter the text you would like to send (this will override your blook):");if(adtext){if(adtext.includes(":")){alert("Ad text cannot include a colon!");return;}setUserVal("b","Dog:"+(new Array(500).fill(adtext).join(" ")));setUserVal("tat",`${d}:100`);}}
},{
type:"select",name:"Send Ad Text",computed:function(sel){if(Object.keys(gameobject.c).length===Array.from(sel.children).length){return false;}return Object.keys(gameobject.c);},action:function(d){var adtext = prompt("Enter the text you would like to send (this will override your blook):");if(adtext){if(adtext.includes(":")){alert("Ad text cannot include a colon!");return;}setUserVal("b","Dog:"+(new Array(500).fill(adtext).join(" ")));setUserVal("tat",`${d}:100`);}}
},{
type:"cselect",name:"Send Distraction",values:Object.entries({
                            c: "Oh Canada",
                            b: "Blizzard",
                            f: "Fog Spell",
                            d: "Dark & Dusk",
                            ...
                            fr: "Use The Force"
                                ...
                                name: t,
                                value: e
                            })),action:function(val){setUserVal("tat",val);}
}]};
var global = [{
...
type:"button",name:"Freeze Host",action:function(a){if(!fvals?.[botinfo?.type]){alert("Freeze not found for gamemode!");}setUserVal(fvals[botinfo.type],makeLongText(1.5e+5));a.innerText="Freezing";}
},{
...
function createInp(text,action){var inp = document.createElement("div");inp.className="inputcontainer";var ti = document.createElement("div");ti.innerText=text+":";inp.appendChild(ti);var iv = document.createElement("input");iv.addEventListener("keydown",e=>{if(e.keyCode==13){action(iv.value);}});inp.appendChild(iv);inp.addEventListener("click",function(e){if(e.target===iv){return;}action(iv.value);});return inp;}
...
var d = document.createElement("div");d.className = "chatmsg";d.innerText=a.replaceAll("\u202e","");document.querySelector(".chatcontainer").insertBefore(d,document.querySelector(".chatcontainer > div"));}
//CODE END
//CHECKMARK CODE
...
function bypassFilter(str){return "\u202e"+str.split("").reverse().join("");}
